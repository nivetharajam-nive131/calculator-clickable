...
button_add = Button(root, text="+", padx=39, pady=20, command=btn_add)
button_subtract = Button(root, text="-", padx=41, pady=20, command=btn_subtract)
button_multiply = Button(root, text="*", padx=40, pady=20, command=btn_multiply)
button_divide = Button(root, text="/", padx=41, pady=20, command=btn_divide)
button_equal = Button(root, text="=", padx=91, pady=20, command=btn_equal)
button_clear = Button(root, text="Clear", padx=79, pady=20, command=btn_clear)
